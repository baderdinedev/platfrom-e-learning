          ...
          <img id="mt-stamp" src="{{asset('logo.png')}}" alt="72px Stamp Here" />
            ...
            <div class="main-copytext">
                <div class="congrats-copytext">
                    ...
                    <h3 id="user-id">Name & Last Name:  {{ $user->name }}, {{ $user->prenam }} <span></span></h3><br><br>
                    <h3 id="user-id">Birthday date:  {{ $user->birthday_date }} <span></span></h3>
                </div>
...
<div class="text-center">
    <form action="{{ route('certificate.attribute', ['id' => $user->id]) }}" method="POST">
        @csrf
        <button type="submit" class="btn btn-primary">Attribute</button>
    </form>
</div>
