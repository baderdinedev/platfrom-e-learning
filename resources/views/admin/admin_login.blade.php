...
<html lang="en">
    ...
    <body id="page-top">
       ...
       <input id="password" type="password" class="form-control"   name="password" required autocomplete="current-password" placeholder="Password">
                            ...
                            <div class="footer">
                               <p>Copyright &copy; 2020 <a href="">qubec center</a>. All rights reserved.</p>
                            </div>
        ...
        <!-- nice scroll bar -->
        <script src="{{asset('panel/assets/plugins/scrollbar/jquery.nicescroll.min.js')}}panel/assets/plugins/scrollbar/jquery.nicescroll.min.js"></script>
        ...
        <!-- chart -->
   <script src="{{asset('anel/assets/plugins/chartjs-bar-chart/Chart.min.js')}}p"></script>
